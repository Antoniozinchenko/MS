                    ...
                    <div class="col-md-6 about-1">
                        ...
                        <div class="company_describe">
                            ...
                            <div class="describe_full">   
                                Група компаній «MS» започаткувала свою <br> 
                                діяльність у важкий для країни час, та реалізувала <br> 
                                ряд успішних проектів з використанням новітніх<br>
                                технологій, які підвищують рівень комфорту та <br>
                                затишку. Ні для кого не таємниця, що будь-яке <br>
                                будівництво супроводжують нестандартні ситуації, <br> 
                                вирішити які можуть тільки професіонали. Саме такі <br>
                                кваліфіковані працівники складають штат компанії <br>
                                "MS". <br><br>
                                Основним пріорітетом компанії MS – увага до <br> 
                                деталей, так як компанія володіє достатньою <br>
                                кількістю матеріальних та інтелектуальних ресурсів <br> 
                                для вирішення найскладніших завдань. <br>
                                В складі компанії: спеціалісти по  управлінню <br>
                                проектами, архітектурне бюро, будівельна <br> 
                                компанія – генеральний підрядник, <br>
                                юридичний супровід та інші. Девелоперська <br>
                                компанія визнана професіоналами ринку <br> 
                                жителями Західної України. <br>
                                Лише за останній рік компанія здобула ряд <br> 
                                нагород, одні з яких: «За інновації в житлових <br> 
                                комплексах», Будівельна компанія року».
                            </div>   
                            <a href="javascript:;" class="btn_detailed">Більше </a>
                        </div>
                        <!-- test end -->
